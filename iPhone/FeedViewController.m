...
- (void)viewDidLoad {
	...
	self.feeds = [[NSDictionary alloc] initWithObjectsAndKeys:
				  @"http://www.irb.com/rss.xml",@"IRB News",
				  @"http://www.rbs6nations.com/en/RssLatestNews.xml",@"RBS 6 Nations News",
				  nil];
...
- (NSString *)tableView:(UITableView *)tableView titleForFooterInSection:(NSInteger)section{
	...
	return [feed objectForKey:@"description"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	//NSString *imageurl = @"http://www.trumix.com/images/defaultradio.jpg";//[NSString stringWithFormat:@"%@",[item objectForKey:@"imageurl"]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    FeedItemViewController *itemViewController = [[FeedItemViewController alloc] initWithNibName:@"FeedItemViewController" bundle:nil];
